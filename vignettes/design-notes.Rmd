...
SQLTemplate is an application of [Mustache](https://mustache.github.io/)"logic-less templates" to Structured Query Language with a few added added enhancments. In 
additions to the benefits of Mustache, SQL templates provides a features to 
activate parts of a SQL Template. This features promotes the query reuse and 
